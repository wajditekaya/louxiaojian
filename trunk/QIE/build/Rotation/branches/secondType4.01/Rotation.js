...
function Rotation(set){
    ...
    this.panelClass=this.s.panelClass;
...
Rotation.prototype={
    ...
    TabChange:function(n){
        var panelClass=this.s.panelClass;
        if(this.aMtag!=''){
            var m=this.aMtag[n];
            if(panelClass){
                if(this.lDiv&&this.lDiv!=m){
                    (this.lDiv.className.indexOf(panelClass)==-1) && (this.lDiv.className+=' '+panelClass);
                };
                (this.aMtag[n].className.indexOf(panelClass)!=-1) && (this.aMtag[n].className=this.aMtag[n].className.replace(new RegExp('\\s*'+panelClass,'g'),''));
            }else{
