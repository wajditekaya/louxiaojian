...
SliderLayer.prototype={
	 ...
	 slider:function(o,hb){
		 var n=this.index=o.nub,hb=this.handleBx[n],b=0,c=this.getEle(hb).h,d=this.interval,t=0,pt=cssValue(hb,'padding-top'),pb=cssValue(hb,'padding-bottom'),bt=cssValue(hb,'border-top'),bb=cssValue(hb,'border-bottom');
		 ...
		 this.sMove=function(){
			 if(o.mKey){
			    /*展开*/
				if(bt!='0px'){this.setStyle(hb,{'border-top':(Math.ceil(this.Tween(t,b,bt,d)) + "px")})}
			    if(bt!='0px'){this.setStyle(hb,{'height':(Math.ceil(this.Tween(t,b,c,d)) + "px")})}
			    }else{
			    /*收起*/
			    this.setStyle(hb,{'height':(c-Math.ceil(this.Tween(t,b,c,d)) + "px")})
			  }
