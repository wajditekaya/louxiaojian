...
ZBrowser.newListTab=function(S,addLast){
      ...
      /*scrollDistance=ullength-par_w;*//*定义scrollDistance竟然不行*/
	  ...
	  addEvent(previousBut,'mouseout',function(){if(previousTime) clearInterval(previousTime);});
	  addEvent(nextBut,'mouseover',next);
	  addEvent(nextBut,'mouseout',function(){if(nextTime) clearInterval(nextTime);});
