...
// $Id: t_navi_pre.php,v 1.1 2009/08/18 03:22:43 xltxlm Exp $
include_once "t.class.php";
/**
 * Created on 2006-11-21 by Administrator
 *
 */
class t_navi_pre extends t
{
	var $deepth= 0;
	...
	{
		if ($noteInfo["r_url"])
			echo "<span><a href='javascript:void(0)'   id='note{$noteInfo['r_id']}'>{$noteInfo['r_name']}</a> <font color='green'>{$noteInfo['r_url']}</font></span>";
		else
			if ($this->deepth == 0)
