...
// +----------------------------------------------------------------------+
//
// Created by Administrator 2009-7-28
// $Id: ip_server.php,v 1.1 2009/08/18 10:05:00 xltxlm Exp $
ini_set("display_errors",1);
include "header.php";
/**
 * 利用QQ的IP库，查询当前IP所在的地区
 * @since version - 2006-9-12
 */
class appIP
{
	var $file= 'QQWry.Dat';
